...
OBJS=amazon.o user.o db_parser.o product_book.o product.o product_parser.o util.o
...
product_book.o: product_book.cpp product_book.h 
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c product_book.cpp
